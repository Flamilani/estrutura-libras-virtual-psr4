<h3><a data-toggle="tooltip" title="Voltar para Cursos" href="<?= BASE; ?>cursos" class="btn btn-primary">
 ...
 <div class="row">
  <div class="col-sm-4 zindex scroll mCustomScrollbar" data-mcs-theme="dark"> 
...
<?php if(substr($actual_link, 8, 6) != 'entrar'): ?> 
  <div class="list-group mb-3">
  <a style="text-decoration: none;" class="list-group-item active" href="<?php echo BASE; ?>cursos/entrar/<?php echo $curso->getId(); ?>">Bem-Vindo</a>
  </div>
  <?php endif; ?>
